package com.example.experimentodifraccion;
    ...
    init {
        ...
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                maxValue = getInt(R.styleable.RotaryKnobView_maxValue, 4) + 1
                divider = 300f / (maxValue - minValue)
                value = getInt(R.styleable.RotaryKnobView_initialValue, 2)
